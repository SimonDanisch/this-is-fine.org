var hljs = function() {
    ...
    function e1(t) {
        return t instanceof Map ? t.clear = t.delete = t.set = ()=>{
            ...
            var i = t[n];
            "object" != typeof i || Object.isFrozen(i) || e1(i);
        }), t;
    }
    var t2 = e1, n4 = e1;
    t2.default = n4;
    ...
    class o {
        ...
        static _walk(e, t) {
            return "string" == typeof t ? e.addText(t) : t.children && (e.openNode(t), t.children.forEach((t)=>this._walk(e, t)
            ), e.closeNode(t)), e;
        }
        static _collapse(e) {
    ...
    var _ = Object.freeze({
        ...
        SHEBANG: (e = {
            ...
            const t = /^#![ ]*\//;
            return e.binary && (e.begin = ((...e)=>e.map((e)=>g(e)
                ).join("")
            )(t, /.*\b/, e.binary, /\b.*/)), a({
                className: "meta",
                begin: t,
    ...
    function O(e, t) {
        Array.isArray(e.illegal) && (e.illegal = ((...e)=>"(" + e.map((e)=>g(e)
            ).join("|") + ")"
        )(...e.illegal));
    }
    function A(e, t) {
    ...
    function B(e, t) {
        return t ? Number(t) : ((e)=>I.includes(e.toLowerCase())
        )(e) ? 0 : 1;
    }
    function T(e2, { plugins: t  }) {
        function n(t, n) {
            return RegExp(g(t), "m" + (e2.case_insensitive ? "i" : "") + (n ? "g" : ""));
        }
        class i {
            constructor(){
                this.matchIndexes = {
                }, this.regexes = [], this.matchAt = 1, this.position = 0;
            }
            addRule(e, t) {
                t.position = this.position++, this.matchIndexes[this.matchAt] = t, this.regexes.push([
                    t,
                    e
                ]), this.matchAt += ((e)=>RegExp(e.toString() + "|").exec("").length - 1
                )(e) + 1;
            }
            compile() {
        ...
        return e2.classNameAliases = a(e2.classNameAliases || {
        }), (function t(i, r) {
            const l = i;
            ...
            ), e2.compilerExtensions.forEach((e)=>e(i, r)
            ...
            let o = null;
            if ("object" == typeof i.keywords && (o = i.keywords.$pattern, delete i.keywords.$pattern), i.keywords && (i.keywords = j(i.keywords, e2.case_insensitive)), i.lexemes && o) throw Error("ERR: Prefer `keywords.$pattern` to `mode.lexemes`, BOTH are not allowed. (see mode reference) ");
    ...
    function P(e2) {
        const t = {
            ...
            computed: {
                ...
                highlighted () {
                    if (!this.autoDetect && !e2.getLanguage(this.language)) return console.warn(`The language "${this.language}" you specified could not be found.`), this.unknownLanguage = !0, s(this.code);
                    let t = {
                    };
                    return this.autoDetect ? (t = e2.highlightAuto(this.code), this.detectedLanguage = t.language) : (t = e2.highlight(this.language, this.code, this.ignoreIllegals), this.detectedLanguage = this.language), t.value;
                },
                autoDetect () {
    ...
    return ((e)=>{
        const n3 = Object.create(null), s = Object.create(null), a = [];
        let r = !0;
        ...
        function f(e, t, s, l) {
            ...
            function g() {
                null != R.subLanguage ? (()=>{
                    ...
                    if ("string" == typeof R.subLanguage) {
                        if (!n3[R.subLanguage]) return void k.addText(M);
            ...
            function x(n2, a) {
                ...
                if (L > 100000 && L > 3 * a.index) throw Error("potential infinite loop, way more iterations than matches");
                return M += l, l.length;
            }
            const v = N(e);
            ...
            try {
                ...
                if (n1.message && n1.message.includes("Illegal")) return {
                    illegal: !0,
                    illegalBy: {
                        msg: n1.message,
        ...
        function p(e, t) {
            t = t || u.languages || Object.keys(n3);
            const i = ((e)=>{
                const t = {
                    relevance: 0,
        ...
        function x(e) {
            ...
            const n = ((e)=>{
                ...
                if (n) {
                    const t = N(n[1]);
                    return t || (U(o.replace("{}", n[1])), U("Falling back to no-highlight mode for this block.", e)), t ? n[1] : "no-highlight";
                }
        ...
        function N(e) {
            return e = (e || "").toLowerCase(), n3[e] || n3[s[e]];
        }
        ...
        "undefined" != typeof window && window.addEventListener && window.addEventListener("DOMContentLoaded", ()=>{
            ...
            registerLanguage: (t, i)=>{
                ...
                try {
                    ...
                    if ($("Language definition for '{}' could not be registered.".replace("{}", t)), !r) throw e2;
                    $(e2), s = g;
                }
                s.name || (s.name = t), n3[t] = s, s.rawDefinition = i.bind(null, e), s.aliases && R(s.aliases, {
                    languageName: t
                });
            },
        ...
        for(const e2 in _)"object" == typeof _[e2] && t2(_[e2]);
    ...
    return (n)=>{
        ...
        return {
            ...
            contains: [
                ...
                {
                    begin: (s = /@/, ((...e)=>e.map((e)=>((e)=>e ? "string" == typeof e ? e : e.source : null
                            )(e)
                        ).join("")
                    )("(?=", s, ")")),
                    end: "[{;]",
...
hljs.registerLanguage("python", (()=>{
    ...
    return (e)=>{
        const n = {
            ...
            className: "comment",
            begin: (d = /# type:/, ((...e)=>e.map((e)=>((e)=>e ? "string" == typeof e ? e : e.source : null
                    )(e)
                ).join("")
            )("(?=", d, ")")),
            end: /$/,
...
hljs.registerLanguage("c", (()=>{
    "use strict";
    function e(e) {
        return ((...e)=>e.map((e)=>((e)=>e ? "string" == typeof e ? e : e.source : null
                )(e)
            ).join("")
        )("(", e, ")?");
    }
